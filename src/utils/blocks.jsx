...
export function HeroSection(userProps) {

    // ── Helper: build per-corner border-radius string ────────────
  const buildRadius = (tl = 0, tr = 0, br = 0, bl = 0) =>
    `${tl}px ${tr}px ${br}px ${bl}px`;

  // ── Helper: build per-side border shorthand ──────────────────
...
export const AboutSection = (props) => {
  ...
  const textCol = (
    ...
    >
      ...
      {description && (
        <p style={{ color: `#${bodyColor}`, fontSize: bodyFontSize }}>
          {description}
        </p>
      )}
        ...
        <ul style={{ listStyle: "none", padding: 0 }}>
          {listItems.map((item, i) => (
            <li key={i} style={{ display: "flex", gap: 8 }}>
              <span style={{ color: `#${listIconColor}` }}>
                {item.icon || "✓"}
              </span>
              <span style={{ color: `#${listTextColor}` }}>{item.text}</span>
            </li>
          ))}
        </ul>
      )}
  ...
  return (
    <section
      ...
      style={{
        display: "flex",
        gap: columnGap || 40,
        background: `#${backgroundColor || "f5f0ea"}`,
        padding: "60px 40px",
      }}
    >
    ...
    >
      ...
      <style>{`
        .${uid}-grid {
          ...
          gap: ${rowGap}px ${gridGap}px !important;
          width: 100% !important;
        ...
        {Items && typeof Items === "function" ? (
          <Items
            ...
            style={{
              ...
              gap: `${rowGap}px ${gridGap}px`,
              width: "100%",
              boxSizing: "border-box",
            }}
          />
        ) : children ? (
          <div className={`${uid}-grid`}>{children}</div>
        ) : (
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%" }}>
        ...
        {/* Content (builder or normal React) */}
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%" }}>
        ...
        {Items && typeof Items === "function" ? (
          <Items
            ...
            className={
              layout === "horizontal" ? "cms-cardsection-horizontal" : undefined
            }
          />
        ) : children ? (
          <div style={getLayoutStyle()}>{children}</div>
        ) : (
...
export const ImageSection = ({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          flex: isVertical ? "0 0 auto" : `0 0 ${imageWidth || 50}%`,
      ...
      <div style={{ flex: 1, zIndex: 1 }}>
        ...
        {description && <p style={{ lineHeight: 1.7 }}>{description}</p>}
      </div>
    </div>
  );
};

export const Spacer = ({ height = 40, backgroundColor = "transparent" }) => {
  return (
    <div
      style={{
...
export const Card = ({
  ...
  const paddingTop = props.paddingTop || 16;
  const paddingLeft = props.paddingLeft || 16;
  const paddingRight = props.paddingRight || 16;
    ...
    >
      ...
      {image && (
        <img
          ...
          alt={title}
          style={{
            height: imageHeight ? `${imageHeight}px` : "180px",
            objectFit: "cover",
            display: "block",
...
export const Testimonials = ({
  ...
  const uid = `t-${(title || "testimonials")
    .replace(/\s+/g, "-")
    .toLowerCase()}`;

  const isAuto = autoScroll === "true";

  const scrollItems = isAuto && items.length > 0 ? [...items, ...items] : items;

  return (
    <section
      id={htmlId || undefined}
      className={className || undefined}
      style={{ ...buildStyle(props), position: "relative" }}
    >
      <Overlay color={overlayColor} />
      ...
      >
        ...
        {isAuto && (
          <style>{`
            ...
            @keyframes ${uid}-marquee {
              from {
                transform: translateX(${direction === "rtl" ? "-50%" : "0%"});
              }
              to {
                transform: translateX(${direction === "rtl" ? "0%" : "-50%"});
              }
            }
          `}</style>
        )}
        ...
        >
          <div
            className={isAuto ? `${uid}-track` : undefined}
            style={{
              display: "flex",
              gap: `${gap}px`,
            }}
...
export const Accordion = ({
  ...
  return (
    ...
    >
      ...
      >
        <style>{`
          .cms-accordion details[open] {
            border-color: #c7d2fe !important;
            box-shadow: 0 0 0 3px rgba(99,102,241,0.12);
          }
          .cms-accordion details[open] summary {
  ...
  components: {
    HeroSection: {
      ...
      defaultProps: {
        ...
        // Per-corner radius — all 0 by default
        borderRadiusTopLeft: 0,
        borderRadiusTopRight: 0,
        borderRadiusBottomRight: 0,
        borderRadiusBottomLeft: 0,

        // Per-side border — all none by default
        borderTopWidth: 0,
        borderTopStyle: "none",
        borderTopColor: "#e5e7eb",
        borderRightWidth: 0,
        ...
        // Show/hide toggles — all visible by default
        showHeading: "true",
        showSubheading: "true",
        showDescription: "true",
        showPrimaryButton: "true",
