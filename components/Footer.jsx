...
import { MapPin, Mail, Phone, Instagram, Facebook, Twitter, Linkedin, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            ...
            <p className="text-stone-400 mb-6 leading-relaxed max-w-sm">
              Premium tiles, flooring & renovation materials. Transform your space with quality products and expert guidance.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <a href="mailto:hello@myhomestore.com" className="hover:text-white transition-colors">
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {["Tiles", "Flooring", "Cladding", "Decking", "Bathroom", "Kitchen"].map((item) => (
                <li key={item}>
                  <motion.a
                    href="#"
                  ...
                  >
                    <span className="w-0 group-hover:w-1.5 h-1.5 bg-amber-500 rounded-full transition-all duration-300" />
                    {item}
                  </motion.a>
                </li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {["Delivery & Freight", "Returns Policy", "Order Samples", "Installation Guide", "FAQs", "Warranty"].map((item) => (
                <li key={item}>
                  <motion.a
                    href="#"
                    whileHover={{ x: 5, color: "#ffffff" }}
