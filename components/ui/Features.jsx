...
const Features = () => {
  ...
  return (
    <section
      className="relative p-5 py-28 md:p-20 bg-[#EDE6E1] mt-[500px] sm:mt-[380px] lg:mt-[300px]"
    >
      <h2 className="max-w-[100%] md:max-w-[80%] text-3xl sm:text-4xl font-bold mx-auto text-center xl:text-left">Shop by categories</h2>
