...
export default function Products() {
  ...
  return (
    <div className="w-full mt-40 flex flex-col items-center">
      <h2 className="text-5xl font-bold mb-16">Products</h2>
      {/* Viewport */}
  ...
  <AnimatePresence mode="wait">
    <motion.div
      ...
      exit="exit"
      className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 w-full max-w-7xl"
    >
        ...
        >
          ...
          <div className="p-5 space-y-3">
            ...
            <div className="flex items-baseline gap-2 pt-2">
              ...
              <span className="text-base text-gray-400 line-through font-medium">$200</span>
